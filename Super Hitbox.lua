...
-- Add padding borders in BizHawk (this generates a *lot* of lag)
xExtra = 0
yExtra = 0
if client and client.SetGameExtraPadding then
    --xExtra = 256
    --yExtra = 224
...
function on_paint()
    ...
    then
        local samusXPosition = sm.getSamusXPosition(i)
        local samusYPosition = sm.getSamusYPosition(i)
