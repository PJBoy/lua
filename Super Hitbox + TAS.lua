...
local colour_scroll_red   = 0xFF000000 + colour_opacity
local colour_scroll_blue  = 0x0000FF00 + colour_opacity
local colour_scroll_green = 0x00FF0000 + colour_opacity
...
local colour_samus            = 0x80FFFF00 + colour_opacity -- actual X distance = expected X distance
local colour_samus_armPumping = 0x00FF0000 + colour_opacity -- actual X distance > expected X distance
local colour_samus_2          = 0xFF800000 + colour_opacity -- actual X distance > expected X distance * 3 / 4
local colour_samus_3          = 0xFF000000 + colour_opacity -- actual X distance > expected X distance / 2
local colour_samus_4          = 0x80000000 + colour_opacity -- actual X distance <= expected X distance / 2
